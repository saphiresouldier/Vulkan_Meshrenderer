...
namespace Saphire
{
  ...
  void RenderEngine::createSurface(Saphire::WindowingSystem winSys) {
  ...
  VkExtent2D RenderEngine::chooseSwapExtent(Saphire::WindowingSystem winSys, const VkSurfaceCapabilitiesKHR& capabilities) {
